...
import com.gengli.technician.adapter.CalendarPagerAdapter;
import com.gengli.technician.bean.AttrsBean;
import com.gengli.technician.bean.DateBean;
import com.gengli.technician.listener.CalendarViewAdapter;
import com.gengli.technician.listener.OnMultiChooseListener;
...
import com.gengli.technician.util.SolarUtil;
...
//                mAttrsBean.setShowLunar(ta.getBoolean(attr, true));
    ...
    public CalendarView setMultiDate(List<String> dates) {
        List<int[]> multiDates = new ArrayList<int[]>();
